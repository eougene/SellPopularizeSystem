...
public class CommissionDetailsActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        tvFirstDate.setText(MyUtils.getInstance().date2String("yyyy/MM/dd ", Long.parseLong(resultBean.getFirst_time() + "000")));

        tvSecondtCom.setText("2. " + resultBean.getSecond_commossion() + " / - / ");
        tvSecondtDate.setText(MyUtils.getInstance().date2String("yyyy/MM/dd ", Long.parseLong(resultBean.getSecond_time() + "000")));


        tvThreeCom.setText("3. " + resultBean.getThird_commossion() + " / - / ");
        tvThreeDate.setText(MyUtils.getInstance().date2String("yyyy/MM/dd ", Long.parseLong(resultBean.getThird_time() + "000")));

        tvSunCom.setText(getString(R.string.total) + resultBean.getCommossion() + " / " + resultBean.getGst() + " / " + resultBean.getTotal());
