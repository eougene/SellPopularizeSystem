...
public class BriefNotificFragment extends BaseFragmentView implements PullToRefreshLayout.OnRefreshListener {
    public static BriefNotificFragment notificFragment;
    ...
    public static BriefNotificFragment getInstnce(int cate_id) {
        BriefNotificFragment notificFragmen = new BriefNotificFragment();
