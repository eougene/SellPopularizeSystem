...
import com.yd.org.sellpopularizesystem.utils.GetTeamNameSort;
...
public class LawyerActivity extends BaseActivity implements PullToRefreshLayout.OnRefreshListener {
    ...
    private GetTeamNameSort teamNameSort;
    ...
    private void jsonParse(String json, boolean isRefresh) {
        ...
        if (isRefresh) {
            ...
            if (strTeam == null) {
                ...
                teamAdapter = new TeamAdapter(LawyerActivity.this, teamGroupListData);
    ...
    public void setListener() {
        if (lawyerListData.size() > 0 || teamGroupListData.size() > 0) {
            if (strTeam == null) {
                listView.setAdapter(lawyerAdapter);
            } else {
                listView.setAdapter(teamAdapter);
                    ...
                    if (firstVisibleItem != lastFirstVisibleItem) {
                        ...
                        if (firstVisibleItem == 0) {
                            ...
                            if (strTeam == null) {
                                ...
                                title.setText(teamGroupListData.get(firstVisibleItem).getSurname() + getString(R.string.single_blank_space) + teamGroupListData.get(firstVisibleItem).getFirstname());
                            }
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (strSearch.length() > 0) {
                if (strTeam == null) {
                    ...
                    ArrayList<TeamBean.ResultBean.SubBeanX> fileterList = (ArrayList<TeamBean.ResultBean.SubBeanX>) teamNameSort
                            .search(strSearch, teamGroupListData);
                    teamAdapter.updateListView(fileterList);
                }
                ...
                if (strTeam == null) {
                    ...
                    teamAdapter.updateListView(teamGroupListData);
                }
            }
